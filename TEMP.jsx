      ...
      <div className="container relative z-10">
        <div className="heading z-10 relative flex flex-col justify-center sm:items-center sm:text-center">
          <div className="heading flex flex-col justify-center sm:items-center sm:text-center">
            <h2 className="font-medium text-2xl xs:text-[1.7rem] tracking-tight dark:text-wht-gradient">
              Let’s Connect!
            </h2>
            ...
            <div className="wrap self-end">
              <div className="mt-4 btn uppercase flex justify-center self-end">
                <a
                  ...
                  className="uppercase font-base flex h-full justify-center items-center py-3 px-10 dark:text-white border-primary rounded-3xl whitespace-nowrap font-Montserrat font-semibold text-[0.8rem]  max-w-[228px] discglow-btn"
                >
                  Join our Discord
                </a>
              </div>
            ...
            <div className="w-full grid justify-center gap-3">
              ...
              <div className="mt-4 btn uppercase flex justify-center">
                <a
                  ...
                  className="uppercase font-base flex h-full justify-center items-center py-3 px-10 dark:text-white border-primary rounded-3xl whitespace-nowrap font-Montserrat font-semibold text-[0.8rem]  max-w-[228px] twtglow-btn"
                >
                  Join us on Twitter
                </a>
              </div>
            ...
            <div className="w-full grid justify-center gap-3">
              ...
              <div className="mt-4 btn uppercase flex justify-center">
                <a
                  ...
                  className="uppercase font-base flex h-full justify-center items-center py-3 px-10 dark:text-white border-primary rounded-3xl whitespace-nowrap font-Montserrat font-semibold text-[0.8rem] max-w-[228px] insta-glowing-btn"
                >
